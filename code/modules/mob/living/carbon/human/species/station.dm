...
/datum/species/slime
	...
	species_traits = list(LIPS, IS_WHITELISTED, NO_BREATHE, NO_INTORGANS, NO_SCAN, NO_PAIN, RADIMMUNE)
	clothing_flags = HAS_UNDERWEAR | HAS_UNDERSHIRT | HAS_SOCKS
	...
	has_organ = list(
		...
		"Soul" = /obj/item/organ/internal/heart/gland/heals
		)
...
#define SLIMEPERSON_HUNGERCOST 5
#define SLIMEPERSON_MINHUNGER 25
#define SLIMEPERSON_REGROWTHDELAY 50 // 45 seconds
